    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardDescription>
            Enter your @neu.edu.ph email and password to access your account
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          {/* NEU Google Login Button (Highlighted) */}
          <Button 
            variant="outline" 
          ...
          >
            ...
            <span className="text-xs ml-1 opacity-75">(@neu.edu.ph)</span>
          </Button>
